...
**One installer per platform — everything is inside.** The statistical/vision engine ships *within* every installer as a bundled sidecar; there is no second download and no Python to install.
